export const messages = {
    ...
    updateBlogFailedDescription : "user might not be the author of this blog or please try again",
    createBlogSucceedTitle : "Successfully create the blog!",
    createBlogSucceedDescription : "refresh to update the page",
    createBlogFailedDescription : "please refresh and check either the session isnr't expired",
    ...
    signInSucceedDescription : "I hope you enjoy exploring this simple Blog Web Application!",
    signUpFailedDescription : "there might be some errors in the server side",
    signUpSucceedTitle : "Successfully sign up, Welcome!",
    signUpSucceedDescription : "I hope you enjoy exploring this simple Blog Web Application!",
